...
- (void)viewDidLoad {
    ...
    _titleTextView = [[UITextView alloc]initWithFrame:CGRectMake(10, 0, self.view.bounds.size.width-20, 100)];
...
//               _tableView.frame = CGRectMake(0, 0, self.view.bounds.size.width, 300+_noteTextView.frame.size.height);
                return  textFrame.size.height+48;
...
//         NSLog(@"\n%@,\n%@,\n%@,\n%@",_eventCal.date,_eventCal.startTime,[NSDate dateWithTimeInterval:(24*60*60) sinceDate:_eventCal.date],_eventCal.endTime);
        ...
        _noteLable.font = [UIFont boldSystemFontOfSize:16];
